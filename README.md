...
[rhit_proj](rhit_proj): This is the entire project folder for the implementation of the problem  

## Progress
_All done in [rhit_proj](rhit_proj)_  

### Done
Project folders were created  
Folders specific to the STM32 (SVD and src/devices) created and autofilled with necessary code  
src/rhit_proj.adb endless loop added for future code to be added  

### To Do
Drivers for USART and USB  
